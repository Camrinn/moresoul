  ...
  <Section crosses>
    <div className='container lg:flex'>
        <div className='max-w-[25rem]'>
            ...
            <Button className='sm:mb-3'> Try it now</Button>
        </div>
        <div className='mb-2 lg:ml-auto xl:w-[38rem]'>
            <p className='body-2 mb-8 text-n-4 md:mb-16 
            lg:mb-32 lg:w-[22rem] lg:mx-auto'>
                {collabText}
            </p>

            <div className='relative left-1/2 flex w-
            [22rem] aspect-square border border-n-6
                    ...
                    {collabApps.map((app, index) => (
                        ...
                        >
                            <div 
                                ...
                                flex w-[3.2rem] h-[3.2rem] bg-white
                                border border-n-1 rounded-xl
                                -rotate-${
                                    index * 45
                                }`}
                            >
