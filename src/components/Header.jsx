...
const Header = () => {
  ...
  const scrollToFooter = () => {
    ...
    if (footerElement) {
      footerElement.scrollIntoView({ behavior: 'smooth', block: 'nearest' });
    }
  };

  return (
    <div className={`fixed top-0 left-0 w-full z-50 border-b border-n-6 lg:bg-black lg:backdrop-blur-sm ${openNavigation ? 'bg-black' : 'bg-black backdrop-blur-sm'}`}>
      <div className='flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4'>
        <a className='w-[12rem] xl:mr-8'>
          <img src='src/assets/robot23.png' width={190} height={40} alt='Brainwave' />
        </a>
        ...
        {/* Updated Contact Me button to trigger scrolling to the footer */}
        <Button className='hidden lg:flex' onClick={scrollToFooter}>
          Contact Me
        </Button>
